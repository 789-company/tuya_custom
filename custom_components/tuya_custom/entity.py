...
class TuyaEntity(Entity):
    ...
    def __init__(self, device: CustomerDevice, device_manager: Manager) -> None:
        """Init TuyaHaEntity."""
        # Each entity keeps a unique ID tied to the custom domain so it does not
        # collide with the official Tuya integration when both coexist.
        self._attr_unique_id = f"{DOMAIN}.{device.id}"
